            ...
            <div class="card">
                ...
                @endif
                    ...
                    <table class="table" id="buttons-datatables">
                        ...
                        <tbody>
                            @foreach ($salaries as $key => $tran)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $tran->refID }}</td>
                                    <td>{{ $tran->account->title }}</td>
                                    <td>{{ $tran->name}}</td>
                                    <td>{{ $tran->designation}}</td>
                                    <td>{{ $tran->month}}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Create Salary</h5>
                ...
                <form action="{{ route('salaries.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" name="designation" required id="designation"
                                class="form-control">
                        </div>
                        <div class="form-group mt-2">
